import { BuildAad, BuildRawBytes, Cipher, MessageType } from "./cipher";
...
test("Test cipher:", () => {
  ...
  var expectedMessageType = MessageType.TypeSingle;
  var expectedName = gConnName;
  // var expectedSign = type.TypeSingle;
  var epxectedIV = new Uint8Array([
    52, 69, 113, 36, 207, 171, 168, 50, 162, 40, 224, 187,
  ]);
  var epxectedAuthenTag = new Uint8Array([
    106, 232, 205, 181, 53, 106, 177, 50, 190, 131, 144, 7, 101, 44, 27, 45,
  ]);
  var expectedData = new TextEncoder().encode("Goldeneye Technologies");
  var expectedAad = new Uint8Array([
    0, 4, 0, 0, 0, 0, 0, 0, 251, 22, 1, 4, 0, 0, 0, 0, 0, 0, 103, 111, 108, 100,
    101, 110, 101, 121, 101, 95, 116, 101, 99, 104, 110, 111, 108, 111, 103,
    105, 101, 115,
  ]);

  var input = new Uint8Array([
    0, 4, 0, 0, 0, 0, 0, 0, 251, 22, 1, 4, 0, 0, 0, 0, 0, 0, 106, 232, 205, 181,
    53, 106, 177, 50, 190, 131, 144, 7, 101, 44, 27, 45, 52, 69, 113, 36, 207,
    171, 168, 50, 162, 40, 224, 187, 103, 111, 108, 100, 101, 110, 101, 121,
    101, 95, 116, 101, 99, 104, 110, 111, 108, 111, 103, 105, 101, 115, 71, 111,
    108, 100, 101, 110, 101, 121, 101, 32, 84, 101, 99, 104, 110, 111, 108, 111,
    103, 105, 101, 115,
  ]);
...
test("Test Parse No Cipher Bytes:", () => {
  ...
  var expectedName = gConnName;
  var expectedAad = new Uint8Array([
    0, 4, 0, 0, 0, 0, 0, 0, 123, 22, 1, 4, 0, 0, 0, 0, 0, 0, 103, 111, 108, 100,
    101, 110, 101, 121, 101, 95, 116, 101, 99, 104, 110, 111, 108, 111, 103,
    105, 101, 115,
  ]);
  var epxectedSign = new Uint8Array([
    140, 57, 139, 30, 167, 65, 206, 46, 33, 131, 181, 152, 42, 206, 205, 79, 59,
    223, 16, 25, 61, 95, 68, 163, 49, 147, 106, 188, 66, 151, 202, 88,
  ]);
  var expectedData = new TextEncoder().encode("Goldeneye Technologies");

  var input = new Uint8Array([
    0, 4, 0, 0, 0, 0, 0, 0, 123, 22, 1, 4, 0, 0, 0, 0, 0, 0, 140, 57, 139, 30,
    167, 65, 206, 46, 33, 131, 181, 152, 42, 206, 205, 79, 59, 223, 16, 25, 61,
    95, 68, 163, 49, 147, 106, 188, 66, 151, 202, 88, 103, 111, 108, 100, 101,
    110, 101, 121, 101, 95, 116, 101, 99, 104, 110, 111, 108, 111, 103, 105,
    101, 115, 71, 111, 108, 100, 101, 110, 101, 121, 101, 32, 84, 101, 99, 104,
...
function runCases() {
  ...
  let msgTypes = [
    ...
    MessageType.TypeDone,
    MessageType.TypeGroup,
    MessageType.TypeGroupCached,
    MessageType.TypeSingle,
    MessageType.TypeSingleCached,
  ];
...
describe("Test Build Raw Bytes:", () => {
  let expectedRawBytes = new Uint8Array([
    0, 4, 0, 0, 0, 0, 0, 0, 251, 22, 1, 4, 0, 0, 0, 0, 0, 0, 103, 111, 108, 100,
    101, 110, 101, 121, 101, 95, 116, 101, 99, 104, 110, 111, 108, 111, 103,
    105, 101, 115, 71, 111, 108, 100, 101, 110, 101, 121, 101, 32, 84, 101, 99,
